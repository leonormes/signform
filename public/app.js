...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('form').submit(function(e) {
	e.preventDefault();
...
function dayChoices() {
	const days = [];
	const choices = __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.makeArray(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('input[name=days]:checked'));
	choices.forEach((d) => {
		days.push(d.value);
	});
	return days;
 ...
 */
function removeForm() {
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.content_form').remove();
};
...
function formResponse() {
	...
	const page = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('body')[0];
